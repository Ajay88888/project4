...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal,
	  ...
	  StringBuffer sb = new StringBuffer("<select style='width: 177px;  height: 20px;' class='form-control' name='" + name + "'>");
        ...
        if (select) {
            ...
            sb.append("<option style='width: 170px;  height: 20px;' selected value=''>-------------Select---------------</option>");
        }

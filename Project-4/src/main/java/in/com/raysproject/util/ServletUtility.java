...
import in.com.raysproject.ctl.BaseCtl;
import in.com.raysproject.ctl.ORSView;
import in.com.raysproject.exception.ApplicationException;
import in.com.raysproject.model.BaseModel;
...
public class ServletUtility {
	...
	public static void setBean(BaseBean bean, HttpServletRequest 
			 request) {
	...
	public static void handleException(ApplicationException e, HttpServletRequest request,
			HttpServletResponse response)throws IOException, ServletException {
		 request.setAttribute("exception", e);
	        response.sendRedirect(ORSView.ERROR_CTL);		
	}

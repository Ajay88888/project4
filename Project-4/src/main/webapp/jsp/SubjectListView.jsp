...
<%@page import="in.com.raysproject.bean.SubjectBean"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.com.raysproject.ctl.SubjectListCtl"%>
...
<%@include file="Header.jsp"%>
	...
	<center>
		<h1 style="font-size: 30px;">Subject List</h1>
		<center>
		...
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			<table border="1px" width="100%">
				...
				<tr>
					...
					<td align="center"><a href="<%=ORSView.SUBJECT_CTL %>?id=<%=bean1.getId()%>">Edit</a></td>
				</tr>
				<%
					}
				%>

...
<%@page import="in.com.raysproject.bean.CollegeBean" %>
...
<center>
			...
			<jsp:useBean id="bean" class="in.com.raysproject.bean.CollegeBean"
			...
			<table>
				<tr>
					...
					<%= HTMLUtility.getList("name" , String.valueOf(bean.getId()), list1) %>&emsp;
						...
						<label class="p1">City</label> <input type="text" name="city" placeholder="Enter City"
						value="<%=ServletUtility.getParameter("city", request)%>">&emsp;&emsp;
						
						<label class="p1">State</label> <input type="text" name="state" placeholder="Enter State"
